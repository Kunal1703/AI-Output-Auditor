# Novelty prompts (`ENG-NOVELTY`)

Prompt templates for the Novelty Audit Engine's LLM-backed stages
(Document 2, §7.5).

| Template | Frozen pipeline stage | Status |
|---|---|---|
| `functional_repetition_review.v1.md` | Stage 6 — LLM-based Functional Repetition Review | Milestone 3 |
